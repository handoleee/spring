...
<body>
	...
	<!-- 관리자(admin)로 로그인 했을 때만 회원목록 링크 노출 
	...
	<!-- 회원정보 수정 절차
		1단계 : 정보수정 버튼을 클릭하면 DB로부터 내 정보를 가져와서 memberupdate.jsp에 출력을 하고
		2단계 : memberupdate.jsp에서 이메일주소를 수정하고 수정한 내용을 DB에 반영 후
			   다시 membermain.jsp로 돌아옴.-->
