...
<!-- Header Section Begin -->
    ...
    <div style="width: 1400px; left: 50%; margin-left: 700px;">
		<h2 style="color: #7fad39"><b>상품 수정</b></h2><br>
	<form action="shopupdateprocess" method="post" enctype="multipart/form-data">
		상품번호:<br>
		<input type="text" name="snumber" value="${shopUpdate.snumber}" ><br>
		상품이름:<br>
		<input type="text" name="sname" value="${shopUpdate.sname}" ><br>
		가격:<br>
		<input type="text" name="sprice" value="${shopUpdate.sprice}"><br>
		재고:<br> 
		<input type="text" name="sstock"value="${shopUpdate.sstock}"><br>
		대표사진:<br>
		<input type="file" name="sfile"  value="${shopUpdate.sfilename}"><br>
		원산지:<br>
		<input type="text" name="sorigin" value="${shopUpdate.sorigin}"><br>
		제조사:<br>	
		<input type="text" name="smake" value="${shopUpdate.smake}"><br>
		구성:<br>
		<input type="text" name="sbox" value="${shopUpdate.sbox}"><br>
		유통기한:<br>
		<input type="text" name="stime" value="${shopUpdate.stime}"><br>
		상세정보:<br>
		<input type="text" name="scontents" value="${shopUpdate.scontents}"><br>	
